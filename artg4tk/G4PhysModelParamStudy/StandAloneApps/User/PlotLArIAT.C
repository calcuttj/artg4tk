...
void
PlotLArIAT(std::string fname)
{

  std::string hnameLAr[6] = {
    "Edep", "EdepZ", "EdepR", "HShowerEdep", "HShowerEdepZ", "HShowerEdepR"};
  //
  std::string thetaHARP_FW[5] = {"0.05", "0.1", "0.15", "0.2", "0.25"};
  std::string thetaHARP_LA[10] = {
  ...
  //
  std::string variants[3] = {
    "G4-default", "Bertini-RScale=1. (D=2.82)", "Bertini-XSecScale=0.1 (D=1.)"};
