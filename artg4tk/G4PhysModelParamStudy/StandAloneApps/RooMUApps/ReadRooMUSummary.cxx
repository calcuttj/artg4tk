...
main(int argc, char** argv)
{
  ...
  if (argc != 5) {
    ...
    std::cout << " Usage format: ReadRooMUSummary -i <inputfilename>.root -d <roomuhistosdir>"
              << std::endl;
    return 1;
  }
  ...
  if (!tstfile->GetDirectory(summarydir.c_str())) {
    std::cout << " Directory " << summarydir << " does NOT exist in the Root file " << tstfile
              << "; bail out " << std::endl;
    return 0;
  }
