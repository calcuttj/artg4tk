...
// artg4tk::
BeamThinTargetConfig::BeamThinTargetConfig(const int pid, const double m, const int tid) : TNamed()
{
...
// artg4tk::
BeamThinTargetConfig::BeamThinTargetConfig(const BeamThinTargetConfig& rhs) : TNamed(rhs)
{
...
bool
BeamThinTargetConfig::operator==(const BeamThinTargetConfig& rhs) const
{

  return (fBeamPartID == rhs.fBeamPartID && fabs(fBeamMomentum - rhs.fBeamMomentum) < 1.e-10 &&
          fTargetID == rhs.fTargetID);
}
...
// artg4tk::
void
BeamThinTargetConfig::Print(Option_t*) const
{
