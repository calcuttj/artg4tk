...
public:
  // ctor & dtor
  ProcessWrapper(const G4String& name = "ProcessWrapper", G4ProcessType processType = fHadronic)
    : G4HadronicProcess(name, processType)
    ,
    // fInteractionModel(0),
    fStringModel(0)
    , fCascade(0)
  ...
  void
  UseG4LundStringFragm(bool g4lund = true)
  {
    fUseLundStrFragm = g4lund;
    return;
  }
  virtual void
  Compose()
