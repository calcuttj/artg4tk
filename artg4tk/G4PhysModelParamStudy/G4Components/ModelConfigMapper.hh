...
public:
  ...
  void ChangeParameter(const std::string&,
                       const std::string&,
                       const int&,
                       bool verb = false); // empty now
  //
  void ChangeParameterByRatio(const std::string&,
                              const std::string&,
                              const double&,
                              bool verb = false);
  void ChangeParameterByRatio(const std::string&,
...
private:
  ...
  //
  void ChangeParameterViaG4UI(const std::string&,
                              const std::string&,
                              const double&,
                              bool verb = false);
  ...
  std::map<std::string, std::map<std::string, std::string>>
    fDEFAULTS; // NOTE: the reason of doing it as nested map(s)
