...
public:
  ...
  void
  SetDimentions(G4double x1, G4double x2, G4double x3)
  {
    fTargetSize[0] = x1;
    fTargetSize[1] = x2, fTargetSize[2] = x3;
    return;
  }
  void
  SetX(G4double val)
  ...
  void
  SetRMin(G4double val)
  {
    fTargetSize[0] = val;
    return;
  }
  void
  SetRMax(G4double val)
  {
    fTargetSize[1] = val;
    return;
  }
  void
  SetShape(G4String val)
  {
    fShape = val;
    return;
  }
