...
//
// --> FIXME !!! development is broken as on 4/18/17   fHTTP = "http://g4devel.fnal.gov:8080/DoSSiER/WebAPI/get?format=json&record=";
   fHTTP = "http://g4validation.fnal.gov:8080/DoSSiER/WebAPI/get?format=json&record=";
