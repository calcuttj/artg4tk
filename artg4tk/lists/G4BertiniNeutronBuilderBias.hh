...
//----------------------------------------------------------------------------
//
#ifndef G4BertiniNeutronBuilderBias_h
#define G4BertiniNeutronBuilderBias_h 1
...
class G4BertiniNeutronBuilderBias : public G4VNeutronBuilder
{
  public: 
    G4BertiniNeutronBuilderBias(double neutron_bias = 1.);
    virtual ~G4BertiniNeutronBuilderBias() {}
