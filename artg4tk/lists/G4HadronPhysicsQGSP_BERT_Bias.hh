...
//----------------------------------------------------------------------------
//
#ifndef G4HadronPhysicsQGSP_BERT_Bias_h
#define G4HadronPhysicsQGSP_BERT_Bias_h 1
...
class G4HadronPhysicsQGSP_BERT_Bias : public G4VPhysicsConstructor
{
  public: 
    G4HadronPhysicsQGSP_BERT_Bias(G4int verbose =1);
    G4HadronPhysicsQGSP_BERT_Bias(const G4String& name, G4bool quasiElastic=true);
    virtual ~G4HadronPhysicsQGSP_BERT_Bias();
