...
// ###                          MUONPLUS                              ###
// ######################################################################
G4MuonLaser* G4MuonLaser::theInstance = 0;

G4MuonLaser* G4MuonLaser::Definition()
{
  std::cout << "Calling G4MuonLaser::Definition" << std::endl;
  ...
  */
  ...
  theInstance = reinterpret_cast<G4MuonLaser*>(anInstance);
  std::cout << "Returning " << theInstance << std::endl;
  return theInstance;
}

G4MuonLaser*  G4MuonLaser::MuonLaserDefinition()
{
  return Definition();
}

G4MuonLaser*  G4MuonLaser::MuonLaser()
{
  return Definition();
}
